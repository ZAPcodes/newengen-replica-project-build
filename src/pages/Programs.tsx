      ...
      <div className="relative p-6 space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            <program.icon className={`w-5 h-5 bg-gradient-to-r ${program.color} bg-clip-text text-transparent`} />
        ...
        {/* Highlights */}
        <div className="space-y-2">
          <h4 className="text-sm font-semibold text-gray-700">Program Highlights</h4>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-gray-100">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className={`px-6 py-3 bg-gradient-to-r ${program.color} text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center space-x-2`}
          >
...
const Programs = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="pt-20 pb-16 bg-gradient-to-br from-primary-dark via-primary-medium to-secondary-cyan relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              <Zap className="w-5 h-5 text-secondary-cyan" />
            ...
            <motion.h1 
              ...
              className="text-5xl md:text-7xl font-tech font-bold mb-6 leading-tight"
            >
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl text-light-blue max-w-4xl mx-auto leading-relaxed mb-12"
            >
      ...
      >
        <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center shadow-2xl hover:shadow-3xl transition-all duration-300">
