...
const AnimatedStat = ({ value, label, symbol = "", icon: Icon }) => {
  ...
  return (
    <TiltCard>
      <motion.div 
        ref={ref} 
        className="text-center bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover-magnetic"
        whileHover={{ y: -5 }}
      >
    ...
    <section id="who-we-are" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-gray-50 border border-secondary-cyan/20 rounded-full px-6 py-3 mb-8 hover-magnetic">
          ...
          <AnimatedText
            text="Discover the story behind INLIGHN TECH and our commitment to transforming tech education"
        ...
        >
          {cardData.map((card, index) => (
            <TiltCard key={index}>
              <motion.div
                className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 flex flex-col border border-gray-100 group hover-magnetic"
              ...
              >
                ...
                <MagneticButton strength={0.3} range={80}>
                  <button className={`bg-gradient-to-r ${card.gradient} hover:shadow-lg text-white font-semibold py-3 px-6 rounded-xl flex items-center justify-center space-x-2 transition-all duration-300 transform hover:scale-105 shadow-md hover-shine`}>
        ...
        <div className="text-center mt-16">
          <TiltCard>
            <div className="bg-gradient-to-br from-primary-dark to-primary-medium p-8 md:p-12 rounded-3xl text-white shadow-2xl hover-magnetic">
              <AnimatedText
                text="Ready to Start Your Journey?"
                className="text-3xl md:text-4xl font-bold mb-4 text-shadow"
                type="words"
                delay={0.2}
                stagger={0.1}
              />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <MagneticButton strength={0.4} range={120}>
                  <button className="bg-white text-primary-dark font-bold px-8 py-4 rounded-xl hover:bg-light-blue transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 hover-shine">
                    Explore Programs
                  </button>
                </MagneticButton>
